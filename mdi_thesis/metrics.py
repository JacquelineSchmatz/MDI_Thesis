...
def maturity_level(base_data: Dict, filter_date: date) -> Dict[int, int]:
    """
...
def osi_approved_license(base_data: Dict) -> Dict[int, bool]:
    """
...
def criticality_score(base_data: Dict, filter_date: date) -> Dict[int, float]:
    """
    :param data_object: Request object, required to gather data
    of already selected repositories.
...
def pull_requests(base_data: Dict) -> Dict[int, Dict[str, float]]:
    """
...
def project_velocity(base_data: Dict) -> Dict[int, Dict[str, float]]:
    """
...
def github_community_health_percentage(
        base_data: Dict) -> Dict[int, Dict[str, Union[float, bool]]]:
    """
...
def issues(base_data: Dict, filter_date: date) -> Dict[int, Dict[str, float]]:
    """
...
def support_rate(base_data: Dict) -> Dict[int, float]:
    """
...
def code_dependency(base_data: Dict) -> Dict[int, Dict]:
    """
...
def security_advisories(base_data: Dict) -> \
...
def contributions_distributions(base_data: Dict) -> Dict[
    ...
    # NoC metrics
        for repo, commits in commits.items():
            ...
            pareto_results = {
                ...
                "NoC_twenty_percent": twenty_percent,
...
def number_of_support_contributors(base_data: Dict) -> Dict[int, int]:
    """
...
def elephant_factor(base_data: Dict) -> Dict[int, int]:
    """
...
def size_of_community(base_data: Dict) -> Dict[int, float]:
    """
